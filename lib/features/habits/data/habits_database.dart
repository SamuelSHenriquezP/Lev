...
class HabitsDatabase {
  ...
  static final List<MicroHabit> allHabits = [
    ...
    const MicroHabit(
      id: 'pray_07',
      title: 'Lectio Divina / Escucha Contemplativa (Salmo 119:105)',
      levIntro: 'La Palabra no es para leerse de prisa; es agua viva para ser saboreada despacio.',
      steps: [
        'Lee pausadamente: "Lámpara es a mis pies tu palabra, y lumbrera a mi camino." (Salmos 119:105)',
        'Cierra los ojos 20 segundos y deja que una palabra resuene: luz, camino o dirección.',
        'Conversa con Dios en silencio sobre lo que esa palabra despierta en tu presente.',
      ],
      psychologicalBasis: 'Contemplación bíblica milenaria y desaceleración atencional para profunda asimilación cognitiva y espiritual.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '📖',
      tags: ['lectio divina', 'biblia', 'salmo119', 'palabra', 'luz', 'meditacion'],
      interactionType: HabitInteractionType.sensoryAnchor,
    ),
    const MicroHabit(
      id: 'pray_08',
      title: 'Vela de Oración / Entrega en el Silencio (Salmo 62:1-2)',
      levIntro: 'Dios conoce los anhelos más profundos de tu alma antes de que los digas.',
      steps: [
        'Abre tus manos sobre tu regazo en señal de entrega y recepción.',
        'Nombra mentalmente esa carga que hoy te pesa y ponla confiadamente en manos de Cristo.',
        'Medita: "En Dios solamente está acallada mi alma; de él viene mi salvación." (Salmos 62:1)',
      ],
      psychologicalBasis: 'Externalización de la hipervigilancia mediante desahogo emocional y confianza soberana.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🕯️',
      tags: ['vela', 'silencio', 'salmo62', 'entrega', 'peticion', 'oracion'],
      interactionType: HabitInteractionType.audioGrounding,
    ),
    const MicroHabit(
      id: 'pray_09',
      title: 'Cántico Interior y Alabanza en la Naturaleza (Mateo 6:26)',
      levIntro: 'Mira cómo Dios cuida de las criaturas del cielo. ¡Cuánto más cuidará de ti hoy!',
      steps: [
        'Observa por tu ventana o contempla las hojas de mi estanque unos instantes.',
        'Recuerda Mateo 6:26: "Mirad las aves del cielo... y vuestro Padre celestial las alimenta."',
        'Agradece 3 detalles de la naturaleza o provisión que recibiste sin haberlos fabricado tú.',
      ],
      psychologicalBasis: 'Desactivación de la trampa del sobreesfuerzo mediante asombro (Awe) y gratitud teocéntrica.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🌿',
      tags: ['creacion', 'aves', 'mateo6', 'naturaleza', 'alabanza', 'providencia'],
      interactionType: HabitInteractionType.postureRelease,
    ),
    const MicroHabit(
      id: 'pray_10',
      title: 'Armadura de Paz y Firmeza en la Verdad (1 Juan 4:4)',
      levIntro: 'Cuando la duda o el temor te rodeen, vístete de la certeza de quién camina contigo.',
      steps: [
        'Endereza tu espalda y siente la firmeza del suelo bajo tus pies.',
        'Respira hondo declarando: "Mayor es el que está en mí, que el que está en el mundo." (1 Juan 4:4)',
        'Exhala despacio soltando los hombros, con la certeza de que Su fidelidad es tu escudo.',
      ],
      psychologicalBasis: 'Postura corporal de autoeficacia y refutación cognitiva de esquemas de amenaza con verdades de fe.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🛡️',
      tags: ['armadura', 'verdad', 'fuerza', '1juan4', 'temor', 'valentia'],
      interactionType: HabitInteractionType.breathGuided,
    ),
    const MicroHabit(
      id: 'pray_11',
      title: 'Paz en la Tormenta (Marcos 4:39)',
      levIntro: 'Cuando tus pensamientos rujan como olas bravas, recuerda quién tiene la última palabra.',
      steps: [
        'Cierra los ojos y reconoce la tormenta o el agobio que sientes en este momento.',
        'Escucha con fe la voz de Jesús susurrando a tu mar interno: "Calla, enmudece". (Marcos 4:39)',
        'Inhala la calma de Su presencia; exhala el viento de la desesperación hasta que haya gran bonanza.',
      ],
      psychologicalBasis: 'Regulación del pánico mediante simbolismo de control soberano y respiración diafragmática de sosiego.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🌊',
      tags: ['tormenta', 'marcos4', 'bonanza', 'calma', 'ansiedad', 'pánico', 'jesús'],
      interactionType: HabitInteractionType.audioGrounding,
    ),
    const MicroHabit(
      id: 'pray_12',
      title: 'Sinceridad en Getsemaní (Salmo 62:8 / Lucas 22:42)',
      levIntro: 'Delante de Dios no necesitas fingir que eres fuerte. Desahoga tu corazón tal como está.',
      steps: [
        'Pon tu mano sobre el pecho y permítete sentir la vulnerabilidad sin juzgarte.',
        'Dile a Dios en un suspiro honesto lo que más te duele o pesa hoy: "Derramad delante de él vuestro corazón; Dios es nuestro refugio." (Salmo 62:8)',
        'Suelta la necesidad de fingir y descansa en que Él te ama exactamente en tu fragilidad.',
      ],
      psychologicalBasis: 'Catarsis emocional segura y reducción de cortisol al evitar la supresión afectiva.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🌿',
      tags: ['getsemaní', 'vulnerabilidad', 'dolor', 'desahogo', 'salmo62', 'sinceridad'],
      interactionType: HabitInteractionType.holdPressure,
    ),
    const MicroHabit(
      id: 'pray_13',
      title: 'Árbol Junto a Corrientes de Agua (Salmo 1:1-3 / Jeremías 17:8)',
      levIntro: 'Siente tus raíces profundas. Aunque haya sequía a tu alrededor, tu fuente nunca se seca.',
      steps: [
        'Apoya ambos pies descalzos o firmes en el suelo como si fueran raíces botánicas vivas.',
        'Visualiza tus raíces bebiendo del río de Dios: "Será como árbol plantado junto a corrientes de aguas, que da su fruto en su tiempo, y su hoja no cae." (Salmo 1:3)',
        'Inhala la savia de vida que Dios te da; siente la estabilidad que ninguna circunstancia puede derribar.',
      ],
      psychologicalBasis: 'Enraizamiento propioceptivo (grounding) con imaginería somato-espiritual de vitalidad resiliente.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🌳',
      tags: ['raíces', 'árbol', 'salmo1', 'jeremías17', 'estabilidad', 'nutrición', 'vida'],
      interactionType: HabitInteractionType.postureRelease,
    ),
    const MicroHabit(
      id: 'pray_14',
      title: 'Renovación de Alas de Águila (Isaías 40:29-31)',
      levIntro: 'Tu cuerpo y tu mente están fatigados. Deja que Dios te dé alas nuevas para elevarte.',
      steps: [
        'Abre tus brazos despacio hacia los lados como desplegando dos alas.',
        'Medita: "Él da esfuerzo al cansado, y multiplica las fuerzas al que no tiene ningunas... levantarán alas como las águilas." (Isaías 40:29, 31)',
        'Inhala en 4 tiempos llenándote de Su aliento santo; exhala el agotamiento crónico en 6 tiempos.',
      ],
      psychologicalBasis: 'Expansión de la caja torácica para activar la ventilación alveolar e infundir autoeficacia espiritual.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🦅',
      tags: ['águila', 'fuerzas', 'isaías40', 'cansancio', 'burnout', 'renovación'],
      interactionType: HabitInteractionType.breathGuided,
    ),
    const MicroHabit(
      id: 'pray_15',
      title: 'Aguas de Reposo y Pastos Tiernos (Salmo 23:1-3)',
      levIntro: 'El Buen Pastor no te lleva al desierto; te conduce donde tu alma pueda descansar.',
      steps: [
        'Imagina un prado verde de rocío fresco donde Lev y tú descansan sin prisa.',
        'Recita con dulzura: "En lugares de delicados pastos me hará descansar; junto a aguas de reposo me pastoreará. Confortará mi alma." (Salmo 23:2-3)',
        'Haz 3 respiraciones pausadas sintiendo cómo se disuelve la prisa y la exigencia de rendir.',
      ],
      psychologicalBasis: 'Visualización restaurativa de naturaleza y neuroquímica de calma guiada por apego seguro a Dios.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🐑',
      tags: ['salmo23', 'buen pastor', 'aguas', 'descanso', 'pastos', 'paz'],
      interactionType: HabitInteractionType.audioGrounding,
    ),
    const MicroHabit(
      id: 'pray_16',
      title: 'El Filtro de Luz y Verdad (Filipenses 4:8)',
      levIntro: 'Limpiemos la mente de pensamientos grises y llenémosla de lo que da vida.',
      steps: [
        'Detecta un pensamiento de queja o negatividad que haya rondado hoy tu mente.',
        'Aplica el filtro de Filipenses 4:8: "Todo lo que es verdadero, todo lo honesto, todo lo justo, todo lo puro, todo lo amable... en esto pensad."',
        'Reemplaza esa preocupación por un recuerdo hermoso o una verdad de amor que Dios puso en tu camino.',
      ],
      psychologicalBasis: 'Reestructuración cognitiva paulina para detener la rumiación de sesgo negativo.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '💎',
      tags: ['filipenses4', 'mente', 'verdad', 'pureza', 'pensamientos', 'luz'],
      interactionType: HabitInteractionType.sensoryAnchor,
    ),
    const MicroHabit(
      id: 'pray_17',
      title: 'El Silencio del Alma Sosegada (Salmo 131:2)',
      levIntro: 'No necesitas resolverlo todo hoy. Como un niño en brazos de mamá, calla tu alma conmigo.',
      steps: [
        'Cruza los brazos suavemente sobre tu pecho en un abrazo contenedor.',
        'Medita: "En verdad que me he comportado y he acallado mi alma como un niño destetado de su madre; como un niño destetado está mi alma conmigo." (Salmo 131:2)',
        'Permanece en silencio 30 segundos, sin pedir nada, solo disfrutando existir bajo Su mirada.',
      ],
      psychologicalBasis: 'Regulación del sistema límbico mediante quietud sensorial y abrazo contenedor de autocompasión.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '👶',
      tags: ['salmo131', 'silencio', 'sosiego', 'reposo', 'niño', 'ternura'],
      interactionType: HabitInteractionType.holdPressure,
    ),
    const MicroHabit(
      id: 'pray_18',
      title: 'Entrega de la Carga del Mañana (Mateo 6:33-34)',
      levIntro: 'El mañana aún no ha nacido. Dios te dará las fuerzas cuando ese día llegue.',
      steps: [
        'Abre las palmas hacia arriba frente a ti como si sostuvieras las preocupaciones de mañana.',
        'Lee la promesa: "Basta a cada día su propio afán. Mas buscad primeramente el reino de Dios... y todas estas cosas os serán añadidas." (Mateo 6:33-34)',
        'Voltea las manos hacia abajo soltando el control de los días futuros. Eres libre para vivir hoy.',
      ],
      psychologicalBasis: 'Defusión de la ansiedad anticipatoria mediante acto motor de desprendimiento simbólico.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '☀️',
      tags: ['mañana', 'mateo6', 'futuro', 'control', 'afán', 'presente', 'fe'],
      interactionType: HabitInteractionType.postureRelease,
    ),
    const MicroHabit(
      id: 'pray_19',
      title: 'Seguridad en Su Amor Inseparable (Romanos 8:38-39)',
      levIntro: 'Ni el error, ni la tristeza, ni la soledad pueden arrancarte de Sus brazos.',
      steps: [
        'Inhala profundamente sintiendo cómo el oxígeno llena tu ser.',
        'Declara con firmeza: "Por lo cual estoy seguro de que ni la muerte, ni la vida... ni lo presente, ni lo por venir... nos podrá separar del amor de Dios." (Romanos 8:38-39)',
        'Siente la paz inquebrantable de ser amado con un amor eterno que nunca se cansa de ti.',
      ],
      psychologicalBasis: 'Afianzamiento de apego seguro primario que neutraliza los esquemas de abandono o insuficiencia.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '💖',
      tags: ['romanos8', 'amor', 'seguridad', 'incondicional', 'fidelidad', 'vida'],
      interactionType: HabitInteractionType.sensoryAnchor,
    ),
    const MicroHabit(
      id: 'pray_20',
      title: 'Bendición Sacerdotal de Paz y Gracia (Números 6:24-26)',
      levIntro: 'Cerremos esta pausa recibiendo la bendición milenaria que Dios diseñó para ti.',
      steps: [
        'Coloca una mano sobre tu frente y otra sobre tu pecho.',
        'Recibe estas palabras en quietud: "El Señor te bendiga y te guarde; haga resplandecer su rostro sobre ti y tenga de ti misericordia; el Señor alce sobre ti su rostro y ponga en ti paz." (Números 6:24-26)',
        'Exhala con una sonrisa serena: tienes la paz de Dios en tu mente, en tu cuerpo y en tu camino.',
      ],
      psychologicalBasis: 'Inducción de estado psicofisiológico de gracia y coherencia somática mediante bendición ancestral.',
      category: 'Oración / Meditación Bíblica / Fe',
      iconEmoji: '🕊️',
      tags: ['bendición', 'números6', 'shalom', 'rostro', 'paz', 'gracia'],
      interactionType: HabitInteractionType.postureRelease,
    ),
  ];
