                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _buildMinigameQuickCard(
                        ...
                        title: 'Vela de Fe',
                        subtitle: 'Oración y promesas',
                        color: const Color(0xFFFFF9C4),
                        accent: const Color(0xFFB78103),
                        onTap: () => SomaticMinigameModal.open(context, initialGameIndex: 7),
                      ),
                    ],
                  ),
                ),
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _buildEmotionSquare(
                      ...
                      title: 'Oración & Fe',
                      subtitle: 'Paz y descanso en Dios',
                      icon: Icons.auto_awesome_rounded,
                      count: HabitsDatabase.getByCategory('Oración / Meditación Bíblica / Fe').length,
                    ),
